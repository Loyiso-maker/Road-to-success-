...
export default function RoadToSuccess() {
  ...
  const affirmations = [
    "You are building the future you once dreamed about.",
    "Consistency is your real superpower.",
    "Every disciplined day changes your life.",
    "Small progress is still progress.",
    "Your future self will thank you for today.",
    "Discipline is choosing what you want most over what you want now.",
    "Progress, not perfection, is the goal.",
    "You are stronger than your excuses.",
    "Every goal achieved starts with a single step.",
    "Your legacy is built one day at a time.",
  ];

  const [history, setHistory] = useState(() => {
    const savedHistory = localStorage.getItem("road-to-success-history");
    return savedHistory ? JSON.parse(savedHistory) : [];
  });

  const [goals, setGoals] = useState(() => {
    const savedGoals = localStorage.getItem("road-to-success-goals");
  ...
  useEffect(() => {
    localStorage.setItem("road-to-success-goals", JSON.stringify(goals));
  ...
  }, [goals, completedGoals, completionRate]);
  ...
  useEffect(() => {
    localStorage.setItem("road-to-success-reflection", reflection);
    localStorage.setItem(
      "road-to-success-last-save",
      new Date().toLocaleString()
    );
